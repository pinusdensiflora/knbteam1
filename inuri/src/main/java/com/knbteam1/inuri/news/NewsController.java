...
public class NewsController {
	...
	public String create(@Valid NewsForm newsForm, BindingResult bindingResult, Model model,
			@PathVariable("kind") Integer kind, @RequestParam("files") MultipartFile[] files// 파일처리
	) throws IOException {
	...
	public String update(@Valid NewsForm newsForm, BindingResult bindingResult, Model model,
			@PathVariable("id") Integer id, @RequestParam(value = "files", required = false) MultipartFile[] newFiles,
	...
	public String delete(@PathVariable("id") Integer id, @PathVariable("kind") String cate) {
